...
export const SMS_PATTERNS = {
  ...
  CREDIT_KEYWORDS: /(?:credited|deposited|received|added|processed)\s+with|to/i,
  
  // Negative keywords to ignore (debits, OTPs, warnings)
  DEBIT_KEYWORDS: /(?:debited|withdrawn|spent|paid|otp|warning|alert)/i,
